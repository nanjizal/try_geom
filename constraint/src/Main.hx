...
// trilateral drawing and structures
import trilateral.path.Fine; // can use other lighter alternatives for lines and curves
...
class Main {
    ...
    public function new(){
        ...
        mousePos = new Matrix1x4( { x: 100., y:100., z:0., w: 1. } );
        setupExperiments();
    ...
    inline
    function chain(){
        var jointRender = ( i: Int, joint: Matrix1x4 ) 
    ...
    inline
    function linkSpots( index: Int, spots: Array<Matrix1x4>, width: Float, color: AppColors ){
